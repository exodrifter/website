---
created: 2024-11-12T01:20:10Z
---

_no signal_ stream 141:
- Copied TODOs from [20241111000155](20241111000155.md) and [20241111225500](20241111225500.md)

Playtest feedback:
- [x] Update playtester credits
- [x] Activity notes don't have the view component
- [x] Update beds in bedrooms to not be attached to walls
- [x] Change written 2C hint to show the number for sequence E
- [x] Show picture of a fixed printer in printer UI
- [x] 2e-a "key" dialog has incorrect speaker at beginning
- [x] It's possible to be out of fuses by the time you need a fuse for the work area shortcut
- [x] It's possible for the fuse button to be enabled even when there are no more fuses
- [ ] ~~Remove item wall hiding mechanic~~ This isn't causing any issues right now and I don't have to write any code interacting with it, so it's not a great use of my time to do this refactor right now i think.
- [x] keep dorm room doors open
