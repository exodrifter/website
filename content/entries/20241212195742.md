---
created: 2024-12-12T19:57:42Z
---

_no signal_ stream 156:
- Copied TODOs from [20241212034142](20241212034142.md)

Cupola:
- [x] office card clue in 2g does not have corresponding card in 1a, maybe replace with the cupola card?
- [x] Drop bobby's secret room and the dialog hinting at it, replace it with a dialog about the cupola.
- [x] Use G or I in cupola card?
- [x] Connect cupola room
- [x] Label items in cupola
...
TODO:
- [x] Should not be able to open inventory with tab when pgeist circuit is broken
