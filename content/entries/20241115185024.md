---
created: 2024-11-15T18:50:24Z
---

_no signal_ stream 144:
- Copied TODOs from [20241114213755](20241114213755.md)
- Started working on the server computer UI
...
TODO:
- [x] Add overlay to all bedrooms
- [x] Copy issue in "gravity" log, where nevaeh's line about the larger captain room is duplicated
- [ ] Add option for mouse capture instead of mouse wrap for the look controls
- [x] Make sure all of the doors have door covers so you can click on the black area to move to another scene
- [ ] ~~Added some missing animations~~ I think I did this on previous day already
