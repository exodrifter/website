---
created: 2024-11-24T04:15:52Z
---

working on _no signal_ offline:
- Copied TODOs from [20241122172000](20241122172000.md)
- Made the v0.29 build
...
TODO:
- [x] Add XenonFossil to credits for eggbug plush
- [x] Add item labels to activity room
...
- [ ] Add a map button
- [x] Add option for mouse capture instead of mouse wrap for the look controls
- [x] Add a setting to disable mouse warp on edges, since it doesn't work on Wayland.
