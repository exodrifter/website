Earlier today ([20240620_221253](20240620_221253.md)) I ran into the problem that [`ViewportTexture` does not have mipmaps](../notes/godot-viewport-texture-mipmap.md).
